...
CStringUtil::CStringUtil(LPCTSTR prmStr) 
	: m_Buf(NULL)
	, m_BufLen(0)
	, m_Capacity(0)
{
...
CStringUtil::CStringUtil(const CStringUtil &prmObj) 
	: m_Buf(NULL)
	, m_BufLen(0)
	, m_Capacity(0)
{
...
{
	return (prmCharVal < 255 && prmCharVal>0 && isspace(prmCharVal));
}
