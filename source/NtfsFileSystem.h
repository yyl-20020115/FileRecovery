...
*
****************************************************/
#ifndef __NTFSFILESYSTEM_H__
#define __NTFSFILESYSTEM_H__
...
{
public:
	CNtfsFileSystem(IBaseReader *prmReader = 0);
...
private:
	...
	*
	**************************************/
	void GetFileExtent(UCHAR *prmBuf,UINT64 prmMftSector,File_Content_Extent **prmFileExtent);
	...
	*
	**************************************/
	UINT64 ReadFileContent(UCHAR prmDstBuf[],UINT64 prmByteOff,UINT64 prmByteToRead, UINT64 prmFileSize,File_Content_Extent *prmFileExtent);
	...
	*
	**************************************/
	void FreeFileExtent(File_Content_Extent *prmFileExtent);
